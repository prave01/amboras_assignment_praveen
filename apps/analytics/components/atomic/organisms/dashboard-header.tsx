    ...
    <header className="fade-up panel-surface rounded-3xl px-6 py-5 md:px-8 md:py-6">
      ...
      >
        <div>
          ...
          <h1
            className="mt-3 font-heading text-3xl leading-tight text-foreground
              md:text-5xl"
          >
          ...
          <p
            className="mt-3 max-w-2xl text-sm text-muted-foreground
              md:text-base"
          >
            Unified trendlines for revenue, funnel quality, and product
            momentum. Values refresh from live event ingestion.
          </p>
          <div
          ...
          >
            ...
            <span
              className="inline-flex items-center gap-2 rounded-full border
                border-border/70 bg-white/70 px-3 py-1"
            >
              <span
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row md:w-auto">
          <Button
            variant="outline"
            className="h-10 rounded-xl border-primary/25 bg-white/65
              transition-transform duration-150 ease-out hover:bg-white
              active:scale-[0.98]"
            onClick={onRefresh}
          >
            Refresh data
          ...
          <Button
            variant="outline"
            className="h-10 rounded-xl border-rose-200 bg-rose-50 text-rose-700
              transition-transform duration-150 ease-out hover:bg-rose-100
              active:scale-[0.98]"
            onClick={onLogout}
