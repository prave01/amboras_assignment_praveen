...
export function normalizeOverview(payload: ApiEnvelope<unknown> | undefined): OverviewResponse {
...
export function normalizeTopProducts(payload: ApiEnvelope<TopProduct[]> | undefined): TopProduct[] {
